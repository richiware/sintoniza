...
echo '<div>
    <p>'.__('home.intro').'</p>
    <ul>
        <li>'.__('home.fork_note').' <a href="https://github.com/kd2org/opodsync" target="_blank">oPodSync</a></li>
        <li>'.__('home.github_project').' <a href="https://github.com/manualdousuario/sintoniza/" target="_blank">Sintoniza</a></li>
    </ul>

    <h3>'.__('home.tested_apps').'</h3>
    <ul>
        <li>
